...
import {useEvaluated} from '../../api/useEvaluated';
...
const EvaluatedScreen = ({route}) => {
  ...
  const onRefresh = () => {
    ...
    queryClient.invalidateQueries({
      queryKey: ['evaluation', selectedYear, 'Evaluated - Accounting'],
    });
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ImageBackground
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Evaluated</Text>
...
const styles = StyleSheet.create({
  ...
  revertButton: {
    flex: 1,
    backgroundColor: 'rgba(252, 164, 0, 0.92)',
    paddingVertical: 10,
    borderRadius: 5,
    alignItems: 'center',
    marginRight: 5,
