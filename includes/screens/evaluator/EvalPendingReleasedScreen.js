...
const EvalPendingReleasedScreen = ({route}) => {
  ...
  const onRefresh = () => {
    ...
    queryClient.invalidateQueries({
      queryKey: ['evaluation', selectedYear, 'Pending Released - CAO'],
    });
  ...
  const handleEvaluate = item => {
    Alert.alert(
      'Evaluate',
      `Are you sure you want to evaluate ${item.trackingNumber}?`,
      [{text: 'OK', onPress: () => console.log('Evaluated:', item)}],
    );
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ImageBackground
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Pending Released</Text>
      ...
      {isLoading || !data ? (
        ...
        <View
          ...
          <View
            ...
            <Image
              source={require('../../../assets/images/noresultsstate.png')} // Ensure the image is located correctly in your project folder
              style={{
                width: 200,
                height: 200,
                alignSelf: 'center',
...
export default EvalPendingReleasedScreen;
