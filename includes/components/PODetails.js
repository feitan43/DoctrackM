...
export const GeneralInformationCard = ({genInformationData}) => (
  <View style={styles.sectionContainer}>
    ...
    {[
      ...
      {
        label: 'Supplier',
        value: genInformationData.Claimant,
      },
      {
      ...
      {
        label: 'PO Number',
        value: genInformationData.PO_Number,
      },
      {
        label: 'PO Date',
        value: genInformationData.PoDate,
      },
      {
        label: 'PR Sched',
      ...
      {
        label: 'Fund',
        value: genInformationData.Fund,
      },
      {
        label: 'Nature of Payment',
        value: genInformationData.NatureOfPayment,
      },
      {
        label: 'Specifics',
        value: genInformationData.Specifics,
      },
      {
        label: 'Mode',
  ...
  <View style={styles.sectionContainer}>
    ...
    <View style={styles.sectionTable}>
      ...
      {poDetails && poDetails.length > 0 ? (
        poDetails.map((detail, index, arr) => (
          <View key={index}>
            <View
              style={[
                styles.tableRow,
      ...
      {poDetails && poDetails.length > 0 && (
        <View style={styles.totalContainer}>
          <Text style={styles.totalAmountText}>
            TOTAL: {insertCommas(poTotalAmount.toFixed(2))}
          </Text>
        </View>
      )}
    </View>
